...
var bootstrap_min = __webpack_require__("7y3A");
...
var header__ref = Object(preact_min["h"])(
  ...
  Object(preact_min["h"])(
    ...
    Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        match["Link"],
        { "class": "nav-link", activeClassName: "active", href: "/movies" },
        "Movies"
      )
    )
  )
...
var movies_style = __webpack_require__("32yg");
var movies_style_default = /*#__PURE__*/__webpack_require__.n(movies_style);
...
function movie__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function movie__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function movie__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var movie_Movie = function (_Component) {
  movie__inherits(Movie, _Component);

  function Movie() {
    var _temp, _this, _ret;

    movie__classCallCheck(this, Movie);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = movie__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.element = null, _temp), movie__possibleConstructorReturn(_this, _ret);
  }
...
/* harmony default export */ var movies_presentation = (function (_ref) {
  ...
  return Object(preact_min["h"])(
    "div",
    { "class": movies_style_default.a.movies },
...
// CONCATENATED MODULE: ./routes/movies/index.js
...
/* harmony default export */ var components_textarea = (function (_ref) {
  var value = _ref.value,
      name = _ref.name,
      children = _ref.children,
      _onChange = _ref.onChange;
...
// CONCATENATED MODULE: ./routes/movie/movie-presentation.js
...
var movie_presentation__ref2 = Object(preact_min["h"])(
  preact_router_es["Link"],
  { className: "btn btn-warning", href: "/movies" },
  "Cancel"
);

/* harmony default export */ var movie_presentation = (function (_ref) {
  var movie = _ref.movie,
  ...
  return Object(preact_min["h"])(
    ...
    Object(preact_min["h"])(
      input,
      { value: movie.title, name: "title", onChange: onChange },
      "Title"
    ),
    Object(preact_min["h"])(
      components_textarea,
      { value: movie.overview, name: "overview", onChange: onChange },
      "Overview"
    ),
    Object(preact_min["h"])(
      "div",
      ...
      Object(preact_min["h"])(
        "button",
        { type: "button", className: "btn btn-primary", onClick: onSave },
        "Save changes"
      ),
      movie_presentation__ref2
    )
  );
});
// CONCATENATED MODULE: ./routes/movie/movie-container.js
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };



function movie_container__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function movie_container__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function movie_container__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }




var movie_container_MovieContainer = function (_Component) {
  movie_container__inherits(MovieContainer, _Component);

  function MovieContainer() {
    var _temp, _this, _ret;

    movie_container__classCallCheck(this, MovieContainer);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = movie_container__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = { movie: null }, _this.onChange = function (value, name) {
      var _extends2;

      var movie = _extends({}, _this.state.movie, (_extends2 = {}, _extends2[name] = value, _extends2));

      _this.setState({ movie: movie });
    }, _this.onSave = function () {
      alert("Saving " + _this.state.movie.title);
    }, _temp), movie_container__possibleConstructorReturn(_this, _ret);
  }

  MovieContainer.prototype.componentDidMount = function componentDidMount() {
    var _this2 = this;
    ...
    fetch("/api/movies.json").then(function (rsp) {
      ...
      return _this2.setState({ movie: movie });
    });
  };

  MovieContainer.prototype.render = function render(props, _ref) {
    var movie = _ref.movie;

    if (!movie) return null;

    return Object(preact_min["h"])(movie_presentation, {
      movie: movie,
...
// CONCATENATED MODULE: ./routes/movie/index.js
...
var _ref3 = Object(preact_min["h"])(movies_container_MoviesContainer, { path: "/movies" });

var _ref4 = Object(preact_min["h"])(movie_container_MovieContainer, { path: "/movie/:id" });
